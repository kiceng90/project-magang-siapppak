        ...
        <table class="table-print">
            <tbody>
                ...
                <tr>
                    ...
                    <td width="4%" class="text-center">:</td>
                    <td>{{ $identifikasiTerbaru->dpa ? 'Terdapat narasi singkat DPA yang dilakukan.' : 'Tidak memerlukan dukungan psikologis awal (DPA)' }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="4%" class="text-center">:</td>
                    <td>{{ $identifikasiTerbaru->disposisi_pimpinan
