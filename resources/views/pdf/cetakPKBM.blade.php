    ...
    <tr>
        ...
        <td style="vertical-align:top">
            <div style="padding:20px;height:700px">
                <div style=" font-size:28px;font-weight:bold;padding-top:40px;">Satuan Tugas Pusat Krisis Berbasis Masyarakat (SATGAS PKBM)
                </div>
                <div style="font-size:20px;padding-top:5px;">Kecamatan {{$data->kecamatan_name}}</div>
