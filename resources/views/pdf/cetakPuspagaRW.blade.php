        ...
        <tr>
            ...
            <td style="vertical-align:top">
                <div style="padding:20px;height:700px">
                    <div style=" font-size:24px;font-weight:bold;padding-top:5px;">Pusat Pembelajaran Keluarga
                        (PUSPAGA) / Pusat Pelayanan Terpadu Pemberdayaan Perempuan Dan Anak (P2TP2A)
                    </div>
                    <div style="font-size:18px;padding-top:5px;">RW {{$data->rw}}</div>
                    <div style="font-size:18px;padding-top:5px;">Kelurahan {{$data->kelurahan_name}} Kecamatan {{$data->kecamatan_name}}</div>
                    <div style="font-size:16px;padding-top:25px;">No. SK : {{$data->sk_number}}</div>
                    ...
                    <div style="font-size:16px;padding-top:5px;">{{$data->nik}}</div>
                    <div style="font-size:15px;padding-top:25px;font-weight:bold">JABATAN DALAM INSTANSI</div>
                    <div style="font-size:14px;padding-top:5px;">{{$data->jabatan_dalam_instansi_name}}</div>
                    <div style="font-size:15px;padding-top:25px;font-weight:bold">KEDUDUKAN DALAM TIM</div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="vertical-align:top">
                                ...
                                <div style="padding-top:5px;color:#616162;">RT {{$data->rt_domisili}}, RW
                                    {{$data->rw_domisili}}1</div>
                                <div style="padding-top:5px;color:#616162;">Kelurahan
                                    {{$data->kelurahan_domisili_name}}, Kecamatan {{$data->kecamatan_domisili_name}}
                                </div>
                            </td>
                        </tr>
                    </table>
                    <table style="margin-top:10px">
                        <tr>
                            ...
                            <td style="vertical-align:top">
                                ...
                                <div style="padding-top:5px;color:#616162;">RT {{$data->rt_ktp}}, RW {{$data->rw_ktp}}
                                </div>
                                <div style="padding-top:5px;color:#616162;">Kelurahan {{$data->kelurahan_ktp_name}},
                                    Kecamatan {{$data->kecamatan_ktp_name}}</div>
                            </td>
                        </tr>
                    </table>
                </div>
