<table>
    <thead>
        <tr>
            ...
            <th style="border:1px black solid; text-align:center;vertical-align:middle;width:180px;font-weight:bold">TMT Tugas</th>
            ...
            <th style="border:1px black solid; text-align:center;vertical-align:middle;width:180px;font-weight:bold">Status</th>
    ...
    <tbody>
        ...
        <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$key + 1}}</td>
            ...
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->nama_m_konselor}}</td>
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{ \Carbon\Carbon::parse($value->tmt_tugas)->translatedFormat('d F Y')}}</td>
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->alamat_domisili}}</td>
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->nama_kecamatan_domisili}}</td>
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->nama_kelurahan_domisili}}</td>
            ...
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->nama_kecamatan_ktp}}</td>
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->nama_kelurahan_ktp}}</td>
            ...
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{$value->phone_number_m_konselor}}</td>
            ...
            <td style="text-align:center;border:1px black solid;vertical-align:middle">{{ucwords($value->status)}}</td>
