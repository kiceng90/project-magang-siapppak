        ...
        <thead>
            <tr>
                ...
                <th style="border:100px solid white; text-align:center;vertical-align:middle;width:30px;font-weight:bold; background-color:#605c6e;color:white;"
                    colspan="5">Kegiatan Piket Layanan</th>
            </tr>
            <tr>
                <th
            ...
            @foreach ($data as $key => $value)
                @forelse ($value->laporan as $key => $laporan_master)
                    <tr>
                        ...
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->nama_lengkap }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->nik . '‎' }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->no_wa }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->status }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->jenis }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->univ }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->balai_puspaga_kelurahan }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->balai_puspaga_kecamatan }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->balai_puspaga_rw }}</td>
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ $value->identitas_mahasiswa->konselor }}</td>
                        ...
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ empty($laporan_master->piket) ? '-' : $laporan_master->piket->id_laporan_kegiatan }}
                        </td>
                        ...
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ empty($laporan_master->piket) ? '-' : $laporan_master->piket->id_kelurahan }}
                        </td>
            ...
            @foreach ($data as $key => $value)
                @forelse ($value->laporan as $key => $laporan_master)
                    <tr>
                        ...
                        <td style="text-align:center;border:1px black solid;vertical-align:middle">
                            {{ empty($laporan_master->sosialisasi) ? '-' : $laporan_master->sosialisasi->materi_url }}
                        </td>
        ...
        <thead>
            <tr>
                ...
                <th style="border:100px solid white; text-align:center;vertical-align:middle;width:30px;font-weight:bold; background-color:#0ba8b4;color:white;"
                    colspan="4">Identitas Puspaga</th>
                <th style="border:100px solid white; text-align:center;vertical-align:middle;width:30px;font-weight:bold; background-color:#605c6e;color:white;"
                    colspan="8">Kegiatan Piket Layanan</th>
            </tr>
            <tr>
                <th
                    style="border:100px solid white; text-align:center;vertical-align:middle;width:30px;font-weight:bold; background-color:#0d0d86;color:white; height:50px;">
