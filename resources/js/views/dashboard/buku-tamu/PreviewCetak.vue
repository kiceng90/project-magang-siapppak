            ...
            <div class="box-container-print" v-else>
                ...
                <table class="table-print table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td>DISPOSISI PIMPINAN</td>
                            <td v-if="identifikasiKebutuhan.id">
                                {{
                ...
                <div v-if="identifikasiKebutuhan.id">
                    <table
                    ...
                    >
                        <tbody>
                            ...
                            <tr>
                                <td width="30%">
                                    Pemberian Dukungan Psikologis Awal (DPA)
                                </td>
                                <td width="4%" class="text-center">:</td>
                                <td>
                                    {{
                                        identifikasiKebutuhan.dpa
                                            ? "Terdapat narasi singkat DPA yang dilakukan."
                                            : "Tidak ada isian"
                                    }}
                                </td>
                            </tr>
                            <tr v-if="identifikasiKebutuhan.dpa == 1">
                            ...
                            <tr>
                                <td width="30%">
                                    Hasil Assesment / Wawancara Singkat
                                </td>
                                <td width="4%" class="text-center">:</td>
                                <td>
        ...
        async generateReport() {
            ...
            try {
                const response = await Api().get(
                    `/buku-tamu/${this.$route.params.id}/cetak-pdf`,
                    { responseType: "blob" }
                );
                ...
                fileLink.setAttribute(
                    "download",
                    `buku_tamu_${this.bukuTamu.nomor_pendaftaran}.pdf`
                );
