                                    ...
                                    >
                                        ...
                                        <div class="card-body pt-5">
                                            <div class="col-lg-6 pb-5">
                                                ...
                                                >
                                                    <!-- Row 1: Keterangan Status + Filter Badge -->
                                                    <div class="row mb-5">
                                                        <div
                                                            class="col-lg-4 fw-bolder"
                                                        >
                                                            Keterangan Status
                                                        </div>
                                                        <div class="col-lg-8">
                                                            ...
                                                            >
                                                                <!-- Filter Semua -->
                                                                <span
                                                                    class="badge badge-light-primary mb-2 me-3 c-pointer"
                                                                    @click="
                                                                        onClickFilterStatus(
                                                                            undefined
                                                                        )
                                                    ...
                                                    <!-- Row 2: Keterangan Status + Datepicker -->
                                                    <div
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <!-- <li>
                                                                        <router-link :to="{name: 'pengaduan-cetak', params: { id: context.id }}" class="dropdown-item py-3">
                                                                            Cetak Laporan
                                                                        </router-link>
                                                                    </li> -->
                                                                </ul>
...
export default {
    data() {
        return {
            ...
            filter: {
                ...
                startDate: null,
                endDate: null,
                statusBukuTamu: undefined,
            },
            statusBukuTamuOptions: [
                { labelStatus: "Terkonfirmasi", value: "terkonfirmasi" },
                { labelStatus: "Identifikasi", value: "identifikasi" },
            ],
            tableConfig: {
                feeder: {
                    column: [
    ...
    methods: {
        ...
        onDateChange(dates) {
            ...
            this.filter.endDate = dates && dates.length > 1 ? dates[1] : null;
