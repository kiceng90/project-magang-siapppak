    ...
    <div>
                                        ...
                                        <div class="card-body pt-5">
                                            <div class="row">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div
                                                            class="fw-bolder text-center c-primary-custom"
                                                            style="
                                                                font-size: 20px;
                                                            "
                                                        >
                                                        ...
                                                        <div
                                                            class="text-center text-gray-600 pt-3"
                                                        >
                                                            Jumlah Anggota
                                                        </div>
                                                    </div>
                                                ...
                                                <template v-slot:body>
                                                    ...
                                                    >
                                                        ...
                                                        <td class="text-left">
                                                            <div>
                                                                {{
                                                                    context.jabatan_dalam_instansi_name
                                                                }}
                                                            </div>
                                                            <div>
                                                                <span
                                                                ...
                                                                ><span
                                                                    class="text-gray-600"
                                                                    >{{
                                                                        context.kedudukan_dalam_tim_name
                                                                    }}</span
                                                                >
                                                            </div>
                                                        </td>
                                                            ...
                                                            >
                                                                <div>
                                                                    ...
                                                                    >
                                                                        Kel.
                                                                        {{
                                                                            context.kelurahan_domisili_name
                                                                        }}
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{
                                flag == "insert"
                                    ? "Tambah Data Puspaga RW"
                                    : "Edit Data Puspaga RW"
                            }}
                        </h5>
                        <div
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <input
                                    class="form-control"
                                    type="text"
                                    placeholder="Contoh: 1829485756389"
                                    autocomplete="off"
                                    v-model="single.nik"
                                />
                                <div
                                    v-if="v$.single.nik.$error"
                                    class="text-danger"
                                >
                                    panjang karakter harus 16!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                ...
                                <input
                                    class="form-control"
                                    type="text"
                                    placeholder="Contoh: 081234567875"
                                    autocomplete="off"
                                    v-model="single.phone"
                                />
                                <div
                                    v-if="v$.single.phone.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <input
                                    class="form-control"
                                    type="text"
                                    placeholder="Contoh: 188.45/48/436.9.11/2022"
                                    autocomplete="off"
                                    v-model="single.skNumber"
                                />
                                <div
                                    v-if="v$.single.skNumber.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <app-datepicker
                                    ...
                                    v-model:value="single.skDate"
                                >
                                </app-datepicker>
                                <div
                                    v-if="v$.single.skDate.$error"
                                    class="text-danger"
                                >
                                    Tanggal SK tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                ...
                                >
                                <app-select-single
                                    v-model="single.puspagaRw"
                                    :placeholder="'Pilih rw'"
                                    :show_search="false"
                                    :options="listRwComputed"
                                    :serverside="false"
                                    :show_button_clear="false"
                                >
                                </app-select-single>
                                <div
                                    v-if="v$.single.puspagaRw.$error"
                                    class="text-danger"
                                >
                                    Puspaga RW tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.kelurahanLembaga.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                    >Kelurahan Lembaga</label
                                >
                                <app-select-single
                                    v-model="single.kelurahanLembaga"
                                    :placeholder="'Pilih Kelurahan'"
                                    :loading="
                                        pageStatus == 'kelurahan-lembaga-load'
                                    "
                                    :show_search="true"
                                    @change-search="getKelurahanLembaga"
                                    :options="listKelurahanLembaga"
                                    :serverside="true"
                                    :show_button_clear="false"
                                >
                                </app-select-single>
                                <div
                                    v-if="v$.single.kelurahanLembaga.$error"
                                    class="text-danger"
                                >
                                    Kelurahan Lembaga tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.positionInstansi.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                    >Jabatan Dalam Instansi</label
                                >
                                <app-select-single
                                    v-model="single.positionInstansi"
                                    :placeholder="'Pilih Jabatan Dalam Instansi'"
                                    :options="listPositionInstansi"
                                    :loading="
                                        pageStatus == 'position-instansi-load'
                                    "
                                    :serverside="true"
                                    @change-search="getpositionInstansi"
                                    :show_button_clear="false"
                                >
                                </app-select-single>
                                <div
                                    v-if="v$.single.positionInstansi.$error"
                                    class="text-danger"
                                >
                                    Jabatan Dalam Instansi tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                    ...
                                    :class="
                                        v$.single.bank.$error
                                            ...
                                            : ''
                                    "
                                    >Nomor Rekening Bank Jatim</label
                                >
                                <input
                                    class="form-control"
                                    type="text"
                                    placeholder="Contoh: 177729887"
                                    autocomplete="off"
                                    v-model="single.bank"
                                />
                                <div
                                    v-if="v$.single.bank.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-6 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.positionSk.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                    >Jabatan Dalam SK</label
                                >
                                <app-select-single
                                    v-model="single.positionSk"
                                    :placeholder="'Pilih Jabatan Dalam SK'"
                                    :options="listPositionSK"
                                    :loading="pageStatus == 'position-sk-load'"
                                    :serverside="true"
                                    @change-search="getPositionSk"
                                    :show_button_clear="false"
                                >
                                </app-select-single>
                                <div
                                    v-if="v$.single.positionSk.$error"
                                    class="text-danger"
                                >
                                    Jabatan Dalam SK tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.subJasaPelayanan.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                    >Penerima Jasa Pelayanan</label
                                >
                                <app-select-single
                                    v-model="single.subJasaPelayanan"
                                    :placeholder="'Pilih Jasa Pelayanan'"
                                    :show_search="false"
                                    :options="listSubJasaPelayananComputed"
                                    @option-change="single.jasaPelayanan = {}"
                                    :serverside="false"
                                ...
                                <div
                                    v-if="v$.single.subJasaPelayanan.$error"
                                    class="text-danger"
                                >
                                    Penerima Jasa Pelayanan tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.jasaPelayanan.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                    >Jenis Jasa Pelayanan</label
                                >
                                <app-select-single
                                    v-model="single.jasaPelayanan"
                                    :placeholder="'Pilih Jenis Jasa Pelayanan'"
                                    :options="listJasaPelayanan"
                                    :loading="
                                        pageStatus == 'jasa-pelayanan-load'
                                    "
                                    :serverside="true"
                                    :disabled="!single.subJasaPelayanan.id"
                                    @change-search="getJasaPelayanan"
                                    :show_button_clear="false"
                                >
                                </app-select-single>
                            ...
                            <div class="col-lg-5 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.subDistrictDomicile.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                ...
                                >
                                <app-select-single
                                    v-model="single.subDistrictDomicile"
                                    :placeholder="'Pilih kecamatan'"
                                    :options="listSubDistrictDomicile"
                                    :loading="
                                        pageStatus ==
                                        'sub-district-domicile-load'
                                    "
                                    @option-change="single.villageDomicile = {}"
                                    :serverside="true"
                                    @change-search="
                                        (keyword, limit) =>
                                            getSubDistrict(
                                ...
                                <div
                                    v-if="v$.single.subDistrictDomicile.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-3 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.villageDomicile.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                ...
                                >
                                <app-select-single
                                    v-model="single.villageDomicile"
                                    :placeholder="'Pilih kelurahan'"
                                    :options="listVillageDomicile"
                                    :loading="
                                        pageStatus == 'village-domicile-load'
                                    "
                                    :serverside="true"
                                    :disabled="!single.subDistrictDomicile.id"
                                    @change-search="
                                        (keyword, limit) =>
                                            getVillage(
                                                keyword,
                                                limit,
                                                single.subDistrictDomicile.id,
                                                'listVillageDomicile',
                                                'village-domicile-load'
                                            )
                                    "
                                    :show_button_clear="false"
                                >
                                ...
                                <div
                                    v-if="v$.single.villageDomicile.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-2 mb-5">
                                ...
                                <div
                                    v-if="v$.single.rtDomicile.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-2 mb-5">
                                ...
                                <div
                                    v-if="v$.single.rwDomicile.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-12 mb-5">
                                <label
                                    class="form-label fw-bolder fs-6"
                                    :class="
                                        v$.single.addressDomicile.$error
                                            ? 'text-danger'
                                            : ''
                                    "
                                ...
                                <textarea
                                    class="form-control"
                                    v-model="single.addressDomicile"
                                ></textarea>
                                <div
                                    v-if="v$.single.addressDomicile.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-5 mb-5">
                                ...
                                >
                                <app-select-single
                                    v-model="single.subDistrictKtp"
                                    :placeholder="'Pilih kecamatan'"
                                    :options="listSubDistrictKtp"
                                    :loading="
                                        pageStatus == 'sub-district-ktp-load'
                                    "
                                    @option-change="single.villageKtp = {}"
                                    :serverside="true"
                                    @change-search="
                                        (keyword, limit) =>
                                            getSubDistrict(
                                ...
                                <div
                                    v-if="v$.single.subDistrictKtp.$error"
                                    class="text-danger"
                                >
                                    Kecamatan tidak boleh kosong!
                                </div>
                            ...
                            <div class="col-lg-3 mb-5">
                                ...
                                >
                                <app-select-single
                                    v-model="single.villageKtp"
                                    :placeholder="'Pilih kelurahan'"
                                    :options="listVillageKtp"
                                    :loading="pageStatus == 'village-ktp-load'"
                                    :serverside="true"
                                    :disabled="!single.subDistrictKtp.id"
                                    @change-search="
                                        (keyword, limit) =>
                                            getVillage(
                                                keyword,
                                                limit,
                                                single.subDistrictKtp.id,
                                                'listVillageKtp',
                                                'village-ktp-load'
                                            )
                                    "
                                ...
                                <div
                                    v-if="v$.single.villageKtp.$error"
                                    class="text-danger"
                                >
                                    Kelurahan tidak boleh kosong!
                                </div>
                            ...
                            <div class="col-lg-12 mb-5">
                                ...
                                <textarea
                                    class="form-control"
                                    v-model="single.addressKtp"
                                ></textarea>
                                <div
                                    v-if="v$.single.addressKtp.$error"
                                    class="text-danger"
                                >
                            ...
                            <div class="col-lg-4 mb-5">
                                <label class="form-label fw-bolder fs-6"
                                    >Foto KTP<br /><span
                                        ...
                                        "
                                        >Maksimal ukuran file 5 MB</span
                                    ></label
                                >
                                <div
                                    class=""
                                ...
                                <div
                                        v-if="v$.single.ktp_file.$error"
                                        class="text-danger"
                                        >
                                        File KTP tidak boleh kosong!
                                </div>
                            </div>
                            <div class="col-lg-8 mb-5">
                                <label class="form-label fw-bolder fs-6"
                                    >Unggah File SK</label
                                >
                            ...
                            <div class="col-lg-4 mb-5">
                                <label class="form-label fw-bolder fs-6"
                                    >Foto<br /><span
                                        style="
                                            ...
                                            font-weight: normal !important;
                                        "
                                        >Dimensi gambar direkomendasikan 4x6 &
                                        maksimal ukuran file 5 MB</span
                                    ></label
                                >
                                <div
                                ...
                                >
                                    <img
                                        class="mb-3"
                                        v-if="single.photo_path"
                                        :src="single.photo_path"
        ...
        <div class="modal fade" tabindex="-1" id="modal-import">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Import Data Puspaga</h5>
                        <div
                            class="btn btn-icon btn-sm btn-active-light-primary ms-2"
                            data-bs-dismiss="modal"
                            aria-label="Close"
                            ...
                            <div class="col-lg-12 mb-5">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            <tr
                                                v-for="context in listErrorImport"
                                            >
                                                <td>{{ context.row }}</td>
                                                <td>
                                                    <ul>
                                                        <li
                                                            v-for="error in context.note"
                                                        >
                                                            {{ error }}
                                                        </li>
                                                    </ul>
                                ...
                                >
                                    <!--begin::Icon-->
                                    <span
                                        class="svg-icon svg-icon-2hx svg-icon-primary me-3"
                                    >
                                        <svg
                                            width="32"
                                            height="32"
                                    ...
                                    >
                                        <div class="d-flex flex-column w-100">
                                            ...
                                            <!--begin::Content-->
                                            <span
                                                >Silahkan download format import
                                                terlebih dahulu.</span
                                            >
                                            <!--end::Content-->
                                        </div>
                                        <button
                                            @click="getTemplateImport"
                                            type="button"
...
export default {
    ...
    methods: {
        ...
        initDropzone() {
            const that = this;
            this.dropzoneUpload = new Dropzone("#dropzone-upload", {
                url: "/",
            ...
            this.dropzoneImport = new Dropzone("#dropzone-import", {
                url: "/",
                dictCancelUpload: "Cancel",
                maxFilesize: 50,
                parallelUploads: 1,
        ...
        edit(id) {
            ...
            Api()
                ...
                .then((response) => {
                    ...
                    this.kecamatanId = context.id_kecamatan;
                    ...
                    if (
                        context.jabatan_dalam_instansi_name &&
                        context.id_jabatan_dalam_instansi
                    ) {
                    ...
                    if (
                        context.kedudukan_dalam_tim_name &&
                        context.id_kedudukan_dalam_tim
                    ) {
                    ...
                    if (
                        context.kecamatan_domisili_name &&
                        context.kecamatan_domisili_id
                    ) {
                    ...
                    if (context.sub_jasa_pelayanan !== null) {
                        this.single.subJasaPelayanan = {
                            id: context.sub_jasa_pelayanan,
                            text: context.sub_jasa_pelayanan,
                        };
                    }
                    ...
                    if (
                        context.kecamatan_ktp_name &&
                        context.kecamatan_ktp_id
                    ) {
                    ...
                    if (
                        context.kelurahan_ktp_name &&
                        context.kelurahan_ktp_id
                    ) {
                    ...
                    if (context.id_kelurahan && context.kelurahan_name) {
                        this.single.kelurahanLembaga = {
                            id: context.id_kelurahan,
                            text: context.kelurahan_name,
                        };
                    }
                })
                .catch((error) => {
        ...
        getDataTable() {
            ...
            if (
                this.single.filter.subDistrict.id &&
                this.single.filter.subDistrict.id != "0"
            ) {
            ...
            if (
                this.single.filter.village.id &&
                this.single.filter.village.id != "0"
            ) {
                Object.assign(params, {
            ...
            if (this.single.filter.rw.id && this.single.filter.rw.id != "0") {
                Object.assign(params, {
                    rw: this.single.filter.rw.id,
                });
            }
        ...
        save() {
            ...
            formData.append(
                "nama_lengkap",
                this.single.name ? this.single.name : ""
            );
            formData.append("nik", this.single.nik ? this.single.nik : "");
            formData.append(
                "nomor_sk",
                this.single.skNumber ? this.single.skNumber : ""
            );
            formData.append(
                "tanggal_sk",
                this.single.skDate ? this.single.skDate : ""
            );
            formData.append(
                "ktp",
                this.single.ktp_file ? this.single.ktp_file : ""
            );
            formData.append(
                "rw",
                this.single.puspagaRw.id ? this.single.puspagaRw.id : 0
            );
            formData.append(
                "foto",
                this.single.photo_file ? this.single.photo_file : ""
            );
            formData.append(
                "id_kelurahan",
                this.single.kelurahanLembaga.id
                    ? this.single.kelurahanLembaga.id
                    : ""
            );
            if (!$.isEmptyObject(this.dropzoneUpload.files)) {
                for (let file in this.dropzoneUpload.files) {
                    formData.append(
                        "file_sk[]",
                        this.dropzoneUpload.files[file]
                    );
                }
            }

            formData.append(
                "id_jabatan_dalam_instansi",
                this.single.positionInstansi.id
                    ? this.single.positionInstansi.id
                    : ""
            );
            formData.append(
                "no_bank",
                this.single.bank ? this.single.bank : ""
            );
            formData.append(
                "id_kedudukan_dalam_tim",
                this.single.positionSk.id ? this.single.positionSk.id : ""
            );
            formData.append(
                "sub_jasa_pelayanan",
                this.single.subJasaPelayanan.text
            );
            formData.append(
                "jasa_pelayanan",
                this.single.jasaPelayanan.id ? this.single.jasaPelayanan.id : 0
            );
            formData.append(
                "id_kelurahan_domisili",
                this.single.villageDomicile.id
                    ? this.single.villageDomicile.id
                    : ""
            );
            formData.append(
                "alamat_domisili",
                this.single.addressDomicile ? this.single.addressDomicile : ""
            );
            formData.append(
                "rt_domisili",
                this.single.rtDomicile.id ? this.single.rtDomicile.id : 0
            );
            formData.append(
                "rw_domisili",
                this.single.rwDomicile.id ? this.single.rwDomicile.id : 0
            );
            formData.append(
                "id_kelurahan_ktp",
                this.single.villageKtp.id ? this.single.villageKtp.id : ""
            );
            formData.append(
                "alamat_ktp",
                this.single.addressKtp ? this.single.addressKtp : ""
            );
            formData.append(
                "rt_ktp",
                this.single.rtKtp.id ? this.single.rtKtp.id : 0
            );
            formData.append(
                "rw_ktp",
                this.single.rwKtp.id ? this.single.rwKtp.id : 0
            );
            formData.append(
                "no_hp",
                this.single.phone ? this.single.phone : ""
            );
            formData.append(
                "email",
                this.single.email ? this.single.email : ""
            );
            Api()
                .post("puspaga", formData)
                .then((response) => {
                    $("#modal-form").modal("hide");

                    this.$swal({
                        title: "Berhasil!",
                        text: "Menambahkan data PUSPAGA RW",
                        icon: "success",
                    }).then((result) => {
        ...
        update() {
            ...
            for (let i = 0; i < this.single.existingSk.length; i++) {
                formData.append(
                    "file_sk_existing[]",
                    this.single.existingSk[i].id
                );
            }
            this.$ewpLoadingShow();

            Api()
                .post(`puspaga/${this.single.id}`, formData)
                .then((response) => {
                    $("#modal-form").modal("hide");

                    this.$swal({
                        title: "Berhasil!",
                        text: "Memperbarui data PUSPAGA RW",
                        icon: "success",
                    }).then((result) => {
                        this.getDataTable();
                    });
        ...
        getpositionInstansi(keyword, limit) {
            this.getSelectList(
                `m-jabatan-dalam-instansi/lists?limit=${limit}&search=${keyword}`,
                "listPositionInstansi",
        ...
        getPositionSk(keyword, limit) {
            this.getSelectList(
                `m-kedudukan-dalam-tim/lists?limit=${limit}&search=${keyword}`,
                "listPositionSK",
                "position-sk-load"
            );
        },
        getJasaPelayanan(keyword, limit) {
            this.getSelectList(
                `m-jasa-pelayanan/lists?limit=${limit}&search=${keyword}`,
                "listJasaPelayanan",
                "listPositionInstansi"
            );
        },
        ...
        reset() {
            ...
            this.kecamatanId = "";
            if (this.$store.state.profile.role_id == this.ROLE_KECAMATAN_ID) {
                this.kecamatanId = this.$store.state.profile.kecamatan_id;
            }
        ...
        getTemplateImport() {
            ...
            Api()
                ...
                .then((response) => {
                    ...
                    link.href = url;
                    link.setAttribute("download", "FORMAT IMPORT PUSPAGA.xlsx");
        ...
        saveImport() {
            ...
            Api()
                .post(`puspaga/import`, formData)
                .then((response) => {
                    $(".modal").modal("hide");

                    this.$swal({
                        title: "Berhasil!",
                        text: "Import data PUSPAGA RW",
                        icon: "success",
                    }).then((result) => {
                        this.tableConfig.config.current_page = 1;
                        this.getDataTable();
                ...
                .catch((error) => {
                    ...
                    if (code == 422) {
                        for (let i = 0; i < res.length; i++) {
                            const index = this.listErrorImport.findIndex(
                                (e) => e.row == res[i].row
                            );
                            if (index >= 0) {
                                this.listErrorImport[index].note =
                                    this.listErrorImport[index].note.concat(
                                        res[i].errors
                                    );
                            } else {
        ...
        getSubDistrictFilter(keyword, limit) {
            ...
            Api()
                .get(`m-kecamatan/lists?search=${keyword}&limit=${limit}&is_surabaya=true`)
                .then((response) => {
        ...
        getKelurahanLembaga(keyword, limit) {
            this.pageStatus = "kelurahan-lembaga-load";

            Api()
                .get(
                    `m-kelurahan/lists?search=${keyword}&limit=${limit}&id_kecamatan=${this.kecamatanId}`
                )
                .then((response) => {
                    this.listKelurahanLembaga = [];

                    for (let i = 0; i < response.data.data.length; i++) {
                        this.listKelurahanLembaga.push({
                            id: response.data.data[i].id,
                            text: response.data.data[i].name,
                        });
                    }
        ...
        getRwFilter(keyword, limit) {
            this.pageStatus = "rw-filter-load";

            Api()
                .get(`puspaga/lists-rw?search=${keyword}&limit=${limit}`)
                .then((response) => {
                    this.listRwFilter = [
                        {
                            id: "0",
        ...
        exportData() {
            ...
            Api()
                ...
                .then((response) => {
                    ...
                    const link = document.createElement("a");
                    link.href = url;
                    link.setAttribute("download", `Export Puspaga RW.xlsx`);
                    document.body.appendChild(link);
                    link.click();
                })
                .catch((error) => {
