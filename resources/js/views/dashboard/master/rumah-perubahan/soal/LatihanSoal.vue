                                                                ...
                                                                >
                                                                    <li>
                                                                        <router-link
                                                                            ...
                                                                            :to="{
                                                                                name: 'rumahperubahan-detaillatihansoal',
                                                                                params: {
                                                                                    id: context.id,
                                                                                },
                                                                            }"
...
export default {
    ...
    methods: {
        ...
        getDataTable() {
            ...
            Api()
                .get("m-soal-rumah-perubahan", { params })
                .then((response) => {
        ...
        update() {
            ...
            Api()
                .put(`m-soal-rumah-perubahan/${this.single.id}`, formData)
                .then(() => {
        ...
        save() {
            ...
            Api()
                .post("m-soal-rumah-perubahan", formData)
                .then(() => {
                    $("#modal-form").modal("hide");
                    this.$swal({
                        title: "Berhasil!",
        ...
        changeStatus(id) {
            this.$ewpLoadingShow();
            Api()
                .put(`m-soal-rumah-perubahan/${id}/switch-status`)
                .then((response) => {
