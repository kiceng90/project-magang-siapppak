                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    ...
                                                    "
                                                    >Master Kategori Tes Rumah Perubahan</span
                                                >
                                            </h3>
                                            <button
                                                type="button"
...
export default {
    ...
    methods: {
        ...
        getDataTable() {
            ...
            Api()
                .get(`m-kategori-rumah-perubahan`, {
                    params,
                })
                .then((response) => {
        ...
        save() {
            ...
            Api()
                .post("m-kategori-rumah-perubahan", formData)
                .then((response) => {
        ...
        update() {
            ...
            Api()
                .post(`m-kategori-rumah-perubahan/${this.single.id}?_method=PUT`, formData)
                .then((response) => {
                    $("#modal-form").modal("hide");
        ...
        changeStatus(id) {
            this.$ewpLoadingShow();
            Api()
                .put(`m-kategori-rumah-perubahan/${id}/switch-status`)
                .then((response) => {
