                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Master Jabatan Dalam Instansi</span>
                                            </h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{flag == 'insert' ? 'Tambah Data Jabatan Dalam Instansi' : 'Edit Data Jabatan Dalam Instansi'}}</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-5">
                            ...
                            <input class="form-control" type="text" placeholder="Contoh: Islam" autocomplete="off"
                                v-model="single.name" />
    ...
    export default {
        ...
        methods: {
            ...
            getDataTable() {
                ...
                Api().get(`m-jabatan-dalam-instansi`, {
                        params
                    })
                    .then(response => {
            ...
            save() {
                ...
                Api().post('m-jabatan-dalam-instansi', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data Jabatan Dalam Instansi',
                            icon: "success",
                        }).then(result => {
            ...
            update() {
                ...
                Api().put(`m-jabatan-dalam-instansi/${this.single.id}`, formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Memperbarui data Jabatan Dalam Instansi',
                            icon: "success",
                        }).then(result => {
                            this.getDataTable();
                        });
            ...
            changeStatus(id) {
                this.$ewpLoadingShow();
                Api().put(`m-jabatan-dalam-instansi/${id}/switch-status`)
                    .then(response => {
            ...
            exportData(){
                this.$ewpLoadingShow();
                Api().get(`m-jabatan-dalam-instansi/export`, {
                    responseType: 'blob',
                }).then(response => {
                    const url = window.URL.createObjectURL(new Blob([response.data]));
                    const link = document.createElement('a');
                    link.href = url;
                    link.setAttribute('download', `Export Master Jabatan Dalam Agama.xlsx`);
