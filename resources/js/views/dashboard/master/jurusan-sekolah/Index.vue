                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Master Jurusan Sekolah</span>
                                            </h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{flag == 'insert' ? 'Tambah Data Jurusan' : 'Edit Data Jurusan'}}</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-5">
                            <label class="form-label fw-bolder fs-6"
                                :class="v$.single.name.$error ? 'text-danger' : ''">Nama Jurusan</label>
                            <input class="form-control" type="text" placeholder="Masukkan nama jurusan"
                                autocomplete="off" v-model="single.name" />
                            <div v-if="v$.single.name.$error" class="text-danger"> Nama Jurusan tidak boleh kosong!
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                Api().post('m-jurusan-sekolah', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data jurusan sekolah',
                            icon: "success",
                        }).then(result => {
            ...
            update() {
                ...
                Api().put(`m-jurusan-sekolah/${this.single.id}`, formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Memperbarui data jurusan sekolah',
                            icon: "success",
                        }).then(result => {
                            this.getDataTable();
                        });
            ...
            changeStatus(id) {
                this.$ewpLoadingShow();
                Api().put(`m-jurusan-sekolah/${id}/switch-status`)
                    .then(response => {
