<template>
    <dashboard-modal title="Tambah Data Sub Kategori Monev" id="modal-tambah" dialog-class="modal-bs">
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            Api().post('m-sub-kategori-laporan-monev', formData)
                .then(response => {
                    ...
                    this.$swal({
                        title: "Berhasil!",
                        text: 'Menambahkan data sub kategori laporan monev',
                        icon: "success",
                    })
                })
                .catch(error => {
