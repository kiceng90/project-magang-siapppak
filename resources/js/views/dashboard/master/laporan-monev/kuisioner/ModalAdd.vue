<template>
    <dashboard-modal title="Tambah Data Kuisioner Laporan Monev" id="modal-tambah" dialog-class="modal-bs">
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            Api().post('m-kuesioner-laporan-monev', formData)
                .then(response => {
                    ...
                    this.$swal({
                        title: "Berhasil!",
                        text: 'Menambahkan data kuisioner laporan monev',
                        icon: "success",
                    })
                })
                .catch(error => {
