                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Master Lokasi
                                                    Kejadian</span>
                                            </h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{flag == 'insert' ? 'Tambah Data Lokasi Kejadian' : 'Edit Data Lokasi Kejadian'}}</h5>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                Api().post('m-lokasi-kejadian', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data lokasi kejadian',
                            icon: "success",
                        }).then(result => {
            ...
            update() {
                ...
                Api().put(`m-lokasi-kejadian/${this.single.id}`, formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Memperbarui data lokasi kejadian',
                            icon: "success",
                        }).then(result => {
                            this.getDataTable();
                        });
            ...
            changeStatus(id) {
                this.$ewpLoadingShow();
                Api().put(`m-lokasi-kejadian/${id}/switch-status`)
                    .then(response => {
