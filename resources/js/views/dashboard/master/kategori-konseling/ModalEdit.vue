<template>
    <dashboard-modal title="Edit Kategori Konseling" id="modal-edit" dialog-class="modal-bs">
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            Api().put(`m-kategori-konseling/${this.data.id}`, formData)
                .then(response => {
                    ...
                    this.$swal({
                        title: "Berhasil!",
                        text: 'Memperbarui data kategori konseling',
                        icon: "success",
                    });
                })
                .catch(error => {
