<template>
    <dashboard-modal title="Tambah Data Kategori Konseling" id="modal-tambah" dialog-class="modal-bs">
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            Api().post('m-kategori-konseling', formData)
                .then(response => {
                    ...
                    this.$swal({
                        title: "Berhasil!",
                        text: 'Menambahkan data kategori konseling',
                        icon: "success",
                    })
                })
                .catch(error => {
