                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Master Kebutuhan Layanan</span>
                                            </h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{flag == 'insert' ? 'Tambah Data Kebutuhan Layanan' : 'Edit Data Kebutuhan Layanan'}}</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-5">
                            ...
                            <input class="form-control" type="text" placeholder="Contoh: Rumah Tangga"
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                Api().post('m-kebutuhan-layanan', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data layanan kejadian',
                            icon: "success",
                        }).then(result => {
            ...
            update() {
                ...
                Api().put(`m-kebutuhan-layanan/${this.single.id}`, formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Memperbarui data layanan kejadian',
                            icon: "success",
                        }).then(result => {
                            this.getDataTable();
                        });
            ...
            changeStatus(id) {
                this.$ewpLoadingShow();
                Api().put(`m-kebutuhan-layanan/${id}/switch-status`)
                    .then(response => {
