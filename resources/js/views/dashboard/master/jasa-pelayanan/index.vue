                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Master Jasa Pelayanan</span>
                                            </h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{flag == 'insert' ? 'Tambah Data Jasa Pelayanan' : 'Edit Data Jasa Pelayanan'}}
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-5">
                            ...
                            <input class="form-control" type="text" placeholder="Masukkan Jasa Pelayanan"
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                Api().post('m-jasa-pelayanan', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan Jasa Pelayanan',
                            icon: "success",
                        }).then(result => {
            ...
            update() {
                ...
                Api().put(`m-jasa-pelayanan/${this.single.id}`, formData)
                    .then(response => {
                        $("#modal-form").modal('hide');
            ...
            changeStatus(id) {
                this.$ewpLoadingShow();
                Api().put(`m-jasa-pelayanan/${id}/switch-status`)
                    .then(response => {
