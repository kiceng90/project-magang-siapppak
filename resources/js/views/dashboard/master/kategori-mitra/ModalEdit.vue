<template>
    <dashboard-modal title="Edit Kategori Mitra" id="modal-edit" dialog-class="modal-bs">
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            Api().put(`m-kategori-mitra/${this.data.id}`, formData)
                .then(response => {
                    ...
                    this.$swal({
                        title: "Berhasil!",
                        text: 'Memperbarui data kategori mitra',
                        icon: "success",
                    });
                })
                .catch(error => {
