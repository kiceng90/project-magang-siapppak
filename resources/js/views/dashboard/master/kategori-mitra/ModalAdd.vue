<template>
    <dashboard-modal title="Tambah Kategori Mitra" id="modal-tambah" dialog-class="modal-bs">
...
export default {
    ...
    methods: {
        ...
        onSubmit(){
            ...
            Api().post('m-kategori-mitra', formData)
                .then(response => {
                    ...
                    this.$swal({
                        title: "Berhasil!",
                        text: 'Menambahkan data kategori mitra',
                        icon: "success",
                    })
                })
                .catch(error => {
