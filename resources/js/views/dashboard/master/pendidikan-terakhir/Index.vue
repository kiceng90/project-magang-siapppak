                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Master Pendidikan Terakhir</span>
                                            </h3>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{flag == 'insert' ? 'Tambah Data Pendidikan Terakhir' : 'Edit Data Pendidikan Terakhir'}}
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-5">
                            ...
                            <input class="form-control" type="text" placeholder="Masukkan Nama Pendidikan"
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                Api().post('m-pendidikan-terakhir', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data pendidikan terakhir',
                            icon: "success",
                        }).then(result => {
            ...
            update() {
                ...
                Api().put(`m-pendidikan-terakhir/${this.single.id}`, formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Memperbarui data pendidikan terakhir',
                            icon: "success",
                        }).then(result => {
                            this.getDataTable();
                        });
            ...
            changeStatus(id) {
                this.$ewpLoadingShow();
                Api().put(`m-pendidikan-terakhir/${id}/switch-status`)
                    .then(response => {
