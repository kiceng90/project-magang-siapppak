<template>
    ...
    >
        ...
        <h3 class="mb-5 pt-5 border-bottom">Konseling / Konsultasi Klien</h3>
        <div class="form-check form-switch mb-5">
            <input
                class="form-check-input"
                type="checkbox"
        ...
        <template v-if="hasKonseling">
            ...
            />
            <label class="form-label fw-bolder fs-6 mb-3"
                >Uraian Singkat Permasalahan</label
            >
            <app-editor
                class="form-control mb-5"
                ...
                contentType="html"
            ></app-editor>
            <label class="form-label fw-bolder fs-6 mt-5">Tindak Lanjut</label>
            <app-editor
                class="form-control mb-5"
        ...
        <template v-if="hasSosialisasi">
            ...
            <label class="form-label fw-bolder fs-6 mb-3"
                >Poin Singkat Materi yang Disampaikan</label
            >
            <app-editor
                class="form-control"
        ...
        <h3 class="mb-5 pt-5 border-bottom">
            Rapat / Koordinasi / Kegiatan Lain
        </h3>
        <div class="form-check form-switch mb-5">
            <input
                class="form-check-input"
        ...
        <template v-if="hasRapat">
            ...
            <label class="form-label fw-bolder fs-6 mb-3">Pimpinan</label>
            <input
                type="text"
                class="form-control mb-5"
            ...
            <label class="form-label fw-bolder fs-6 mb-3">Topik</label>
            <textarea
                type="text"
                class="form-control mb-5"
                v-model="rapat.topik"
            ...
            />
            <label class="form-label fw-bolder fs-6 mb-3">Resume/Hasil</label>
            <app-editor
                class="form-control"
        ...
        <template v-if="!ttd">
            <div class="alert alert-warning mt-10" role="alert">
                <h4 class="alert-heading">
                    Anda belum menambahkan Tanda Tangan!
                </h4>
                <p>
                    Silahkan cantumkan tanda tangan anda.<br />Selanjutnya saat
                    anda menambahkan laporan, anda tidak perlu mencantumkan
                    tanda tangan lagi.
                </p>
            </div>
            <label class="form-label fw-bolder fs-6 mb-3">Tanda Tangan</label>
            <signature-pad
                ref="tandaTangan"
                height="200px"
                width="200px"
                class="form-control"
                style="padding: 0 !important; pointer-events: auto"
                :options="{
                    onBegin: () => {
                        $refs.tandaTangan.resizeCanvas();
                    },
                }"
            />
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            formData.set("id_puspaga_rw", this.id_puspaga_rw);

            if (!this.ttd) {
                const ttd = this.$refs.tandaTangan.saveSignature();
                formData.set("file_ttd", ttd.data);
            }
