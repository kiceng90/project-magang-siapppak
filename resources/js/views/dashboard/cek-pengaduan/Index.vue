                                            ...
                                            <div class="head py-7">
                                                <div
                                                    ...
                                                    <h3 class="card-title text-center align-items-start flex-column"
                                                        style="font-size:2em;">Cek Pengaduan</h3>
                                                    <div class="container py-5" style="width:60%;">
                                                        <h5 class="text-gray-700 text-center">Masukkan Nomor Registrasi,
                                                            NIK, atau nomor identitas untuk melacak progres pengaduan
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
