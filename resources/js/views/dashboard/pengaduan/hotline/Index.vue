                ...
                <div class="card-header border-0 pt-5 align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <app-datepicker type="date" placeholder="Pilih tanggal pengaduan" :format="'DD-MM-YYYY'"
                            :value-type="'YYYY-MM-DD'" :class="'me-3'" :range="true"
                            @change="tableConfig.config.current_page = 1; getDataTable()"
                            :style="'max-width:300px !important;'" v-model:value="single.filter.daterange">
                        </app-datepicker>
    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                Api().post('pengaduan', formData)
                    .then(response => {
                        $("#modal-form").modal('hide');

                        this.$swal({
                            title: "Berhasil!",
                            text: 'Menambahkan data pengaduan',
                            icon: "success",
                        }).then(result => {
            ...
            getSubDistrict(keyword, limit, from) {
                ...
                if (from == 'client-identity') {
                    if (this.single.form.clientIdentity.new.surabayaResidents == 1) {
                        ...
                        paramSurabayaResidents = "&is_surabaya=0";
                        paramDistrictOutsideSurabaya = '&id_kabupaten=' + this.single.form.clientIdentity.new.districtOutsideSurabaya.id
                    }
                }
