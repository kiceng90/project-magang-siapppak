    ...
    <div>
        ...
        <div class="row align-items-center mt-5">
            ...
            <div class="col-lg-7 d-flex flex-wrap" style="justify-content:flex-end;">
                ...
                <button type="button" @click="confirmApporvePengaduan" class="btn bg-success"
                    v-if="$store.state.complaint.detailComplaint.id && $store.state.complaint.detailComplaint.status.id == 4"
                ...
                <button
                    v-if="$store.state.complaint.detailComplaint.id && $store.state.complaint.detailComplaint.status.id == 8"
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8" v-else>
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="accordion" id="kt_accordion_1"
                            v-if="$store.state.complaint.detailComplaint.status.id == 8">
                                    ...
                                    <div class="content-timeline-custom">
                                        ...
                                        <div class="p-3" style="border: 1px dashed #E4E6EF;border-radius:12px;">
                                            <div class="row align-items-center">
                                                ...
                                                <div
                                                    class="col-lg-6 my-1 col-md-6 justify-content-end d-flex align-items-center text-right">
                                                    <button v-if="context.status == 'done'"
                                                        ...
                                                        Detail</button>
                                                    <button
                                                        v-if="context.status == 'done' && $store.state.complaint.detailComplaint.id && $store.state.complaint.detailComplaint.status.id == 8"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            confirmApporvePengaduan() {
                this.$swal({
                    title: 'Setujui Pengaduan?',
                    text: 'Pengaduan yang telah disetujui akan diteruskan ke konselor untuk dilakukan proses penjangkauan',
                    icon: 'warning',
            ...
            approvePengaduan(id) {
                ...
                Api().put(`pengaduan/${this.$route.params.id}/action/kabid`)
                    .then(response => {
                        $(".modal").modal('hide');
            ...
            confirmApporvePenjangkauan() {
                this.$swal({
                    ...
                    text: 'Data yang telah disetujui akan diteruskan ke konselor untuk pembuatan laporan akhir ke Kepala Dinas ',
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#F64E60',
                    cancelButtonColor: '#FFFFFF',
            ...
            showPreparatorStep(id) {
                ...
                if (id == 'data-pelaku') {
                    if (this.$store.state.complaint.detailComplaint.status.id == 8) {
