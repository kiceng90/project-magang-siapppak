                                ...
                                <td class="text-center">
                                    <div class="dropdown" style="position:static !important;">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item py-3" href="javascript:void(0);" v-if="context.status.id == 4" @click="confirmApporvePengaduan(context.id)">
                                                    Setujui Pengaduan
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item py-3" href="javascript:void(0);" v-if="context.status.id == 8" @click="confirmApporvePenjangkauan(context.id)">
                                                    Setujui Hasil
                                                </a>
                                            </li>
                                            <li>
    ...
    export default {
        ...
        methods: {
            ...
            approvePengaduan(id) {
                ...
                Api().put(`pengaduan/${id}/action/kabid`)
                    .then(response => {
                        $(".modal").modal('hide');
