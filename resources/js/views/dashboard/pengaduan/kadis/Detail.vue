    ...
    <div>
        ...
        <div class="row align-items-center mt-5">
            ...
            <div class="col-lg-7 d-flex flex-wrap" style="justify-content:flex-end;">
                <button type="button" class="btn me-3" style="background-color:#fff8dd;" @click="$router.push({name:'pengaduan'})">
                ...
                <button type="button" @click="confirmApprove" class="btn bg-success"
                    v-if="$store.state.complaint.detailComplaint.id && $store.state.complaint.detailComplaint.status.id == 9"
        ...
        methods: {
            ...
            confirmApprove() {
                this.$swal({
                    ...
                    text: "Data yang telah disetujui tidak dapat dikembalikan lagi dan pengaduan akan dianggap selesai",
                    icon: 'warning',
            ...
            approvePenjangkauan() {
                ...
                Api().put(`pengaduan/${this.$route.params.id}/approve/kadis`)
                    .then(response => {
                        $(".modal").modal('hide');
