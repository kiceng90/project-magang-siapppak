                            ...
                            <template v-slot:body>
                                <tr v-for="(context, index) in tableConfig.feeder.data">
                                    ...
                                    <td class="text-left">
                                        ...
                                        <div class="text-gray-600">{{context.nama_kelurahan}},
                                            {{context.nama_kecamatan}}
                                        </div>
                                    </td>
                                    <td class="text-left">
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown" style="position:static !important;">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="dropdown-item py-3" href="javascript:void(0);" v-if="context.status.id == 9" @click="confirmApporvePenjangkauan(context.id)">
                                                        Setujui Hasil
                                                    </a>
                                                </li>
                                                <li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-5 border-bottom pb-5 align-items-center">
                            ...
                            <div class="col-lg-9 mb-5">
                                <input type="text" class="form-control" placeholder="Cth: 3514091234567890"
    ...
    export default {
        ...
        methods: {
            ...
            approvePenjangkauan(id) {
                ...
                Api().put(`pengaduan/${id}/approve/kadis`)
                    .then(response => {
                        $(".modal").modal('hide');
