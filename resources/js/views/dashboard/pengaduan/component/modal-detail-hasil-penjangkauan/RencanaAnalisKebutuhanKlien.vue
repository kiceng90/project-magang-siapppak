<template>
    <div class="modal fade" tabindex="-1" id="modal-detail-rencana-analis-kebutuhan-klien">
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width:1100px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Rencana Analis Kebutuhan Klien Oleh DP3KAPPKB</h5>
