<template>
    <div class="modal fade" tabindex="-1" id="modal-detail-dokumen-pendukung">
                            ...
                            <div class="p-5 mb-8" style="border-radius:10px;border: 1px #E5EAEE solid">
                                <div class="row align-items-center pb-5 mb-5">
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.clientPhoto : []">
                                                <a :href="context.path" data-fancybox="gallery"><img :src="context.path"
                                                        class="w-100" style="max-width:100%;border-radius: 5px;" /></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 mb-5 fw-bolder">
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.clientResidencePhoto : []">
                                                <a :href="context.path" data-fancybox="gallery"><img :src="context.path"
                                                        class="w-100" style="max-width:100%;border-radius: 5px;" /></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.ClientInitialAssistancePhoto : []">
                                                <a :href="context.path" data-fancybox="gallery"><img :src="context.path"
                                                        class="w-100" style="max-width:100%;border-radius: 5px;" /></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.ClientContinuedAssistancePhoto : []">
                                                <a :href="context.path" data-fancybox="gallery"><img :src="context.path"
                                                        class="w-100" style="max-width:100%;border-radius: 5px;" /></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.ClientMonitoringAssistancePhoto : []">
                                                <a :href="context.path" data-fancybox="gallery"><img :src="context.path"
                                                        class="w-100" style="max-width:100%;border-radius: 5px;" /></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.clientIdentityPhoto : []">
                                                <a :href="context.path" data-fancybox="gallery"><img :src="context.path"
                                                        class="w-100" style="max-width:100%;border-radius: 5px;" /></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-3 col-sm-4 mb-5"
                                                v-for="context in data ? data.surat : []">
