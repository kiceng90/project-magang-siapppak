<template>
    <div class="modal fade" tabindex="-1" id="modal-detail-kondisi-klien">
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width:1100px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Kondisi Klien</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="p-5 mb-8" style="border-radius:10px;border: 1px #E5EAEE solid">
                                <div class="row align-items-center pb-5 mb-5">
                                    <div class="col-lg-12">
                                        <h4 class="c-primary-custom mb-8">Kondisi Klien</h4>
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600">
                                        Fisik
                                    </div>
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        {{$noNullable(data ? data.physique : '-')}}
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600">
                                        Psikologis
                                    </div>
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        {{$noNullable(data ? data.psychological : '-')}}
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600">
                                        Sosial
                                    </div>
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        {{$noNullable(data ? data.social : '-')}}
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600">
                                        Spiritual
                                    </div>
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        {{$noNullable(data ? data.spiritual : '-')}}
                                    </div>
                                </div>
                            </div>
                        </div>
