<template>
    <div class="modal fade" tabindex="-1" id="modal-detail-harapan-klien-dan-keluarga">
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width:1100px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Harapan Klien dan Keluarga</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="p-5 mb-8" style="border-radius:10px;border: 1px #E5EAEE solid">
                                <div class="row align-items-center pb-5 mb-5">
                                    <div class="col-lg-12">
                                        <h4 class="c-primary-custom mb-8">Harapan Klien dan Keluarga</h4>
                                    </div>
