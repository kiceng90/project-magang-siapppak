<template>
    <div class="modal fade" tabindex="-1" id="modal-detail-langkah-yang-telah-dilakukan">
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width:1100px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Langkah yang Telah dilakukan</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5 mb-8" style="border-radius:10px;border: 1px #E5EAEE dashed"
                                ...
                                <div class="row pb-5 mb-5">
                                    ...
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        <span v-if="context.service_type == 1">Pendampingan Lanjutan</span>
                                        <span v-else-if="context.service_type == 2">Monitoring/ Home Visit</span>
                                        <span v-else>-</span>
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600">
                                        Tanggal Pelayanan
                                    ...
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        {{$moment(context.service_date).locale('id').format('DD MMMM YYYY')}}
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600">
                                        Pelayanan Yang Diberikan
                                    </div>
                                    <div class="col-lg-8 mb-5 fw-bolder">
                                        {{$noNullable(context.pelayanan ? context.pelayanan.name : '')}}
                                    </div>
                                    <div class="col-lg-4 mb-5 text-gray-600" v-if="context.id_pelayanan == 5">
                                        Kebutuhan Shelter
                                    </div>
                                    <div class="col-lg-8 mb-5 fw-bolder" v-if="context.id_pelayanan == 5">
                                        {{ $noNullable(
                                    ...
                                    <div class="col-lg-8 mb-5">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 mb-5" v-for="file in context.dokumen">
