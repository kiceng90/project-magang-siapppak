                                ...
                                <td class="text-center">
                                    <div class="dropdown" style="position:static !important;">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item py-3" href="javascript:void(0);" v-if="context.status.id == 3" @click="confirmApporvePengaduan(context.id)">
                                                    Setujui Pengaduan
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item py-3" href="javascript:void(0);" v-if="context.status.id == 7" @click="confirmApporvePenjangkauan(context.id)">
                                                    Setujui Hasil Penjangkauan
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item py-3" href="javascript:void(0);" v-if="context.status.id == 7" @click="showModalRollbackPenjangkauan(context.id)">
                                                    Revisi Hasil Penjangkauan
                                                </a>
                                            </li>
                                            <li>
    ...
    export default {
        ...
        methods: {
            ...
            showModalApprove(id) {
                ...
                this.resetApprovalPenangananAwal();

                this.single.approve.complaint_id = id;
            ...
            approvePengaduan() {
                if (!this.single.approve.date) {
                    this.$toast.error("Tanggal tidak boleh kosong!");
                    return false;
                }

                if (!this.single.approve.time) {
                    this.$toast.error("Jam tidak boleh kosong!");
                    return false;
                }

                if (!this.single.approve.place) {
                    this.$toast.error("Tempat tidak boleh kosong!");
                    return false;
                }

                if (!this.single.approve.address) {
                    this.$toast.error("Alamat tidak boleh kosong!");
                    return false;
                }

                if (!this.single.approve.konselor_1.id) {
                    this.$toast.error("Konselor 1 tidak boleh kosong!");
                    return false;
                }
                ...
                let formData = {
                    id_pengaduan: this.single.approve.complaint_id,
            ...
            resetApprovalPenangananAwal() {

                this.pageStatus = 'standby';

                this.single.approve.complaint_id = '';
            ...
            confirmApporvePenjangkauan(id) {
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                        this.approvePenjangkauan(id);
                    }
                });
            },
            approvePenjangkauan(id) {
                this.$ewpLoadingShow();
                ...
                Api().put(`pengaduan/${id}/approve/subkord`, formData)
                    .then(response => {
                        $(".modal").modal('hide');
            ...
            showModalRollbackPenjangkauan(id) {
                $("#modal-rollback").modal('show');

                this.single.rollback.id = id;
            ...
            rollbackPenjangkauan() {
                ...
                Api().put(`pengaduan/${this.single.rollback.id}/approve/subkord`, formData)
                    .then(response => {
                        $(".modal").modal('hide');
