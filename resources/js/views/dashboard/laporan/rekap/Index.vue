                                        ...
                                        <div class="card-header border-0 pt-5 align-items-center">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder text-dark mb-2"
                                                    style="font-size:20px !important;">Laporan Rekap</span>
                                            </h3>
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-lg-9 mb-5">
                                                            <div class="d-flex align-items-center">
                                                                <div class="w-100 me-3">
                                                                    <app-select-single v-model="single.problemType"
                                                                        :placeholder="'Pilih tipe permasalahan'"
                                                                        :disabled="single.checkAllProblemType"
                                                                        :loading="pageStatus == 'problem-type-load'"
                                                                        :options="listProblemType" :serverside="true"
                                                        ...
                                                        <div class="col-lg-9 mb-5">
                                                            <div class="d-flex align-items-center">
                                                                <div class="w-100 me-3">
                                                                    <app-select-single v-model="single.caseCategory"
                                                                        :disabled="!single.problemType.id || single.checkAllCaseCategory"
                                                                        :placeholder="'Pilih kategori kasus'"
                                                                        :loading="pageStatus == 'case-category-load'"
                                                                        :options="listCaseCategory" :serverside="true"
    ...
    export default {
        ...
        watch: {
            'single.type': function () {
                ...
                this.single.problemType = {};
                this.single.caseCategory = {};
        ...
        methods: {
            preview() {
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        problemType: this.single.problemType.id ? this.single.problemType.id : '',
                        caseCategory: this.single.caseCategory.id ? this.single.caseCategory.id : '',
            ...
            excel() {
                ...
                if (this.single.problemType.id) {
                    Object.assign(formData, {
                        id_tipe_permasalahan: this.single.problemType.id
                    });
                }

                if (this.single.caseCategory.id) {
                    Object.assign(formData, {
                        id_kategori_kasus: this.single.caseCategory.id
                    });
                }

                this.pageStatus = 'form-export';

                let fileName = this.single.type == 'year' ? 'Laporan Rekap Tahunan.xlsx' : 'Laporan Rekap Bulanan.xlsx';
                Api().get(urlX, {
                    responseType: 'blob',
                    params: formData
                }).then(response => {
            ...
            getCaseCategory(keyword, limit) {
                ...
                let idTipePermasalahan = this.single.problemType.id;
            ...
            getLastEducation(keyword, limit) {
                ...
                this.pageStatus = 'last-education-load';
                ...
                Api().get(
                    ...
                    .then(response => {
                        ...
                        this.listLastEducation = [];

                        for (let i = 0; i < response.data.data.length; i++) {
                            this.listLastEducation.push({
                                id: response.data.data[i].id,
                                text: response.data.data[i].name,
                            });
                        }
