    ...
    <div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{
                                flag == "insert"
                                    ? "Tambah Data Satgas PPA"
                                    : "Edit Data Satgas PPA"
                            }}
                        </h5>
                        <div
                            ...
                            <div class="col-lg-4 mb-5">
                                <label class="form-label fw-bolder fs-6"
                                    >Foto KTP<br /><span
                                        ...
                                        "
                                        >Maksimal ukuran file 2 MB</span
                                    ></label
                                >
                                <div
                                    class=""
        ...
        <div class="modal fade" tabindex="-1" id="modal-import">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Import Data Satgas PPA</h5>
                        <div
                            class="btn btn-icon btn-sm btn-active-light-primary ms-2"
                            data-bs-dismiss="modal"
                            aria-label="Close"
...
export default {
    ...
    methods: {
        getDataHeader() {
            Api()
                .get(`database/satgas-ppa/rangkuman`)
                .then((response) => {
        ...
        save() {
            ...
            Api()
                .post("database/satgas-ppa", formData)
                .then((response) => {
                    $("#modal-form").modal("hide");

                    this.$swal({
                        title: "Berhasil!",
                        text: "Menambahkan data Satgas PPA",
                        icon: "success",
                    }).then((result) => {
        ...
        update() {
            ...
            Api()
                .post(`database/satgas-ppa/${this.single.id}`, formData)
                .then((response) => {
                    $("#modal-form").modal("hide");

                    this.$swal({
                        title: "Berhasil!",
                        text: "Memperbarui data Satgas PPA",
                        icon: "success",
                    }).then((result) => {
                        this.getDataTable();
                    });
        ...
        changeStatus(id) {
            this.$ewpLoadingShow();
            Api()
                .put(`database/satgas-ppa/${id}/switch-status`)
                .then((response) => {
        ...
        getTemplateImport() {
            this.$ewpLoadingShow();
            Api()
                .get("database/satgas-ppa/download-format", {
                    responseType: "blob",
                })
                .then((response) => {
        ...
        saveImport() {
            ...
            Api()
                .post(`database/satgas-ppa/import`, formData)
                .then((response) => {
                    $(".modal").modal("hide");

                    this.$swal({
                        title: "Berhasil!",
                        text: "Import data Satgas PPA",
                        icon: "success",
                    }).then((result) => {
                        this.tableConfig.config.current_page = 1;
                        this.getDataTable();
        ...
        skDownload(id, name) {
            this.$ewpLoadingShow();
            Api()
                .get(`database/satgas-ppa/${id}/download-sk`, {
                    responseType: "blob",
                })
                .then((response) => {
                    const url = window.URL.createObjectURL(
        ...
        pdfGenerate(id, name) {
            this.$ewpLoadingShow();
            Api()
                .get(`database/satgas-ppa/${id}/cetak-pdf`, {
                    responseType: "blob",
                })
                .then((response) => {
                    const url = window.URL.createObjectURL(
        ...
        exportData() {
            this.$ewpLoadingShow();
            Api()
                .get(`database/satgas-ppa/export`, {
                    responseType: "blob",
                })
                .then((response) => {
                    const url = window.URL.createObjectURL(
                    ...
                    const link = document.createElement("a");
                    link.href = url;
                    link.setAttribute("download", `Export Satgas PPA.xlsx`);
                    document.body.appendChild(link);
                    link.click();
                })
                .catch((error) => {
