...
class SatgasPpaSheetImport implements ToModel, WithHeadingRow, WithValidation, SkipsEmptyRows, WithMultipleSheets
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nik' => 'required|numeric|digits:16|unique:App\Models\SatgasPpa,nik',
            'nomor_sk' => 'required',
            'tanggal_sk' => [
                'required',
