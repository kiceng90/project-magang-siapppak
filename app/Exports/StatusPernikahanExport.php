...
use App\Models\MStatusPernikahan;
...
class StatusPernikahanExport implements FromCollection, WithHeadings, WithEvents
{
    /**
    ...
    public function collection()
{
    ...
    $data = MStatusPernikahan::select('name', 'is_active')->get();
