    ...
    public function store(Request $request)
    {
        try {
            ...
            $rules = [
                ...
                'status' => 'required|in:Anak (<18),Dewasa (>18)',
                ...
                'anda_adalah' => 'required|string',
                'instansi' => 'required|string|max:255',
                'alamat_instansi' => 'required|string',
                'kecamatan_instansi' => 'required|string|max:255',
                'kelurahan_instansi' => 'required|string|max:255',
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $rules = [
                ...
                'metode' => 'sometimes|required|in:Online,Offline',
                'instansi' => 'sometimes|required|string|max:255',
                'alamat_instansi' => 'sometimes|required|string',
                'kecamatan_instansi' => 'sometimes|required|string|max:255',
                'kelurahan_instansi' => 'sometimes|required|string|max:255',
                'unggah_foto' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
                'unggah_ktp' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
                'tanda_tangan' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
                'rating_kegiatan' => 'nullable|integer|min:1|max:5',
