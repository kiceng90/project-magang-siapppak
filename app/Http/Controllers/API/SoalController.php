...
class SoalController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $soal = Soal::where('id_materi', $id_materi)->with('materi');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(['message' => 'Soal dan pilihan jawaban berhasil disimpan'], 201);
        } catch (\Exception $e) {
    ...
    {
        $soal = Soal::with('pilihanJawaban')->where('id_materi', $id)->where('is_active', true)->orderBy('id', 'asc')->get();
